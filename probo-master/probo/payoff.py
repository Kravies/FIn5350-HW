import abc
from numpy import mean, amax, amin, maximum
...
def lookbackCallPayoff(option, maxSpot):
    return maximum(maxSpot - option.strike, 0.0)

def lookbackPutPayoff(option, minSpot):
    return maximum(option.strike - minSpot, 0.0)

def lookbackCallPayoff1(option, spot):
    max = spot.max()
    return maximum(max - option.strike, 0.0)

def lookbackPutPayoff1(option, spot):
    min = spot.min()
    return maximum(option.strike - min, 0.0)
